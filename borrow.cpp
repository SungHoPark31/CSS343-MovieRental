...
Postcondition: Initializes the private variables.
-------------------------------------------------------------*/
Borrow::Borrow(const BinTree& tree)
{
    //Sets the tree.
    theTree = tree;
}
...
the BSTree of Movies.
------------------------------------------------------------*/
void Borrow::setStream(string line, string& transaction)
{
    //Split the string
    ...
    if(genre == "F")
    {
        ...
        theTree.ComedyTransaction(movieTitle, "B", transaction);
    }
    ...
    else if(genre == "D")
    {
        ...
        theTree.DramaTransaction(title, dire, "B", transaction);
    }
    ...
    else if(genre == "C")
    {
        ...
        theTree.ClassicTransaction(quantity, date, actorLast, "B", title, transaction);
    }
    else
    {
